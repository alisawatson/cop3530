...
int countLines(std::string fileName)
{
  ...
  //std::count( std::istreambuf_iterator<char>(myFile), std::istreambuf_iterator<char>(), '\n');
}
...
std::cout<< "Start new Junction sceneloop "<<std::endl;
...
void Game::gameloop()
{
  ...
  Scene* scene;
  while (current.compare("GAME_OVER") != 0)
  {
